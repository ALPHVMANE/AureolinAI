...
<?php include 'asc_navbar.php'; ?>
    ...
    <div class="quiz-container">
        <h2>2/5</h2>
        <div class="image-box">
            <img src="../../../public/images/Aureolin_Train.jpeg" alt="Train">
        </div>
        
        
    <div class="feedback" id="feedback"></div> <!-- Feedback placeholder -->
        <div class="buttons">
            <button class="green" onclick="wrongAnswer()">Char</button>
            <button class="yellow" onclick="wrongAnswer()">Moto</button>
    ...
    <script>
        function nextQuestion() {
            window.location.href = "gameQ3.php";
        }
